...
import lectures.advanced.scala.exercises.Actor
import manning.FP.chapter_7.Nonblocking.Par.parMap
...
object Nonblocking extends App {
  ...
  object Par {
    ...
    def run[A](es: ExecutorService)(p: Par[A]): A = {
      ...
      val dd = p(es)
      val cc = dd.apply { a => ref.set(a); latch.countDown } // Asynchronously set the result, and decrement the latch
